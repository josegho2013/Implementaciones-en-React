const preguntas = [
    ...
    {
      titulo: "Como aprendes React...?",
      opciones: [
        { textoRespuesta: "Sin Contenido", isCorrect: false },
        { textoRespuesta: "Haciendo Proyectos", isCorrect: true },
        { textoRespuesta: "Metiendolo horas", isCorrect: false },
        { textoRespuesta: "Viendo Memes", isCorrect: false },
      ],
    },
    {
